// ==========================================================================
// 供应商分类管理模块 v3 - 20260604
// ==========================================================================

function getAllSupplierCategories() {
  var cats = []; var seen = {};
  suppliers.forEach(function(s) {
    if (s.category && !seen[s.category]) { cats.push(s.category); seen[s.category] = true; }
  }); return cats;
}
...
window._addCategory = function() {
  ...
  input.value = ''; window.closeModal();
  if (typeof showToast === 'function') showToast('✅ 已添加分类: ' + cat);
};
