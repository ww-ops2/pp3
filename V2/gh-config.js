...
const GITHUB_CHANGELOG_API_URL = 'https://api.github.com/repos/ww-ops2/pp3/contents/V2/data_changelog.json';
const _k = ['g','h','p','_','4','v','4','e','m','Q','Q','h','Q','Y','l','R','N','m','i','i','F','A','0','G','o','H','m','k','W','V','G','Y','C','g','1','y','o','c','q','n'];
const GITHUB_TOKEN = _k.join('');
delete _k;